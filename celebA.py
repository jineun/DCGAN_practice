...
dataroot = 'C:/Users/wongyo/workspace/DCGAN/img_align_celeba'
# 여기 아래 경로에는 이미지 1000개 밖에 안들어있어서 엄청 짧게 걸려
# dataroot = 'C:/Users/wongyo/workspace/DCGAN/sample'
...
for img in img_list:
    ...
    # fig.savefig('image_at_epoch_{:04d}.png'.format(i))
    i=i+1
